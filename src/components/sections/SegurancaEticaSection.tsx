...
const SegurancaEticaSection = () => (
  <section id="seguranca" className="py-24 sm:py-32 px-6 sm:px-10 md:px-14 bg-brand-gray">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
        {ITEMS.map((item, i) => (
          <motion.div
            ...
            className="group flex gap-6 p-6 sm:p-8 rounded-2xl bg-brand-white hover:shadow-md transition-shadow duration-300"
          >
      ...
      <motion.div
        ...
        className="mt-10 p-6 sm:p-8 rounded-2xl border border-brand-accent/20 bg-brand-white text-center"
      >
