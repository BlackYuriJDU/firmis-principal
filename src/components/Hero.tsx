...
const Hero = () => (
  <section className="relative flex flex-col items-center min-h-dvh">
    <VideoBg />

    <div className="relative z-10 flex flex-col items-center flex-1 w-full">
      <div className="pt-28 sm:pt-32 md:pt-40 px-4 sm:px-6 text-center">
        ...
        <a
          href="/cadastro"
          className="inline-block mt-6 sm:mt-8 md:mt-10 px-6 sm:px-8 py-4 bg-[#191919] text-white text-sm font-medium rounded-lg hover:bg-[#191919]/90 transition-colors duration-200"
        >
          Comece agora
        </a>
      </div>
